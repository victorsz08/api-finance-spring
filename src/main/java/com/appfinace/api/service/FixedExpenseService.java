...
public class FixedExpenseService {
    ...
    public void create(FixedExpenseRequestDto data, UUID categoryId, UUID userId) {
    ...
    public List<FixedExpenseResponseDto> listByFiltred(
        ...
        Page<FixedExpense> fixedExpenseFiltred = this.fixedExpenseRepository.getFiltredFixedExpenses(userId, categoryId,
    ...
    public void update(UUID id, FixedExpenseRequestDto data, UUID categoryId) {
        FixedExpense fixedExpense = this.fixedExpenseRepository.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Despesa não localizada"));
